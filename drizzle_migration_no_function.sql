-- Migration: Add Cross-Border Payment Support (No Function Modification)
-- Run this in Drizzle Studio by selecting all statements and executing as batch
-- This version skips function creation to avoid permission issues
...
SELECT 
    ...
    'Note: If trigger was not created, updated_at must be managed manually' as note,
    NOW() as completed_at;
-- Development Tracking System Migration - Separate Queries
-- Run these SQL queries individually in order
...
-- Drop function first if it exists with different owner
...
-- You can now use the development tracking system!
-- Access the admin interfaces at:
-- - /admin/feedback (to convert feedback to development items)
-- - /admin/development (to manage development items and track progress)

...
<div class="max-w-screen-2xl mx-auto px-6 sm:px-8 lg:px-12 py-8">
		...
		<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
			<div class="flex items-center gap-4">
				...
				<div>
					...
					<p class="mt-1 text-gray-600">View and manage all bookings for this tour</p>
				</div>
			</div>
	...
	<div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-8">
		...
		<div class="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
			...
			<p class="text-xl font-bold text-gray-900">{stats.confirmed}</p>
		...
		<div class="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
			...
			<p class="text-xl font-bold text-gray-900">{stats.upcoming}</p>
		...
		<div class="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
			<div class="flex items-center justify-between mb-2">
				<div class="p-2 bg-orange-50 rounded-lg">
					<Euro class="h-4 w-4 text-orange-600" />
				</div>
			</div>
			<p class="text-xl font-bold text-gray-900">€{stats.revenue}</p>
		...
		<div class="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
			...
			<p class="text-xl font-bold text-gray-900">{stats.participants}</p>
			<p class="text-xs text-gray-600 mt-1">Participants</p>
		</div>
		...
		<div class="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
			<div class="flex items-center justify-between mb-2">
				<div class="p-2 bg-gray-50 rounded-lg">
					<UserCheck class="h-4 w-4 text-gray-600" />
				</div>
			</div>
						...
						<div class="flex-1">
							...
							<div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
								...
								<div class="p-3 bg-gray-50 rounded-lg">
									...
									<p class="text-sm font-semibold text-gray-900">€{booking.totalAmount}</p>
